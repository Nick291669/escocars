      ...
      <div className="mx-auto max-w-lg">
        ...
        <div className="mt-10 rounded-[2rem] border border-white/10 bg-white/[0.035] p-6 shadow-2xl md:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-zinc-500">
            Erstelle dein Kundenkonto, um Anhänger anzufragen und deine Buchungen zu verwalten.
          </p>
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            <label className="block text-sm text-zinc-300">
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 outline-none focus:border-amber-400/60"
              />
            </label>
            ...
            <label className="block text-sm text-zinc-300">
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-white/10 bg-black/30 px-4 py-3 outline-none focus:border-amber-400/60"
              />
              <span className="mt-1 block text-xs text-zinc-600">Mindestens 6 Zeichen.</span>
            </label>
            ...
            <button
              ...
              className="w-full rounded-xl bg-amber-400 px-4 py-3.5 font-semibold text-black hover:bg-amber-300 disabled:cursor-not-allowed disabled:opacity-50"
            >
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            Schon registriert?{' '}
            <Link href={`/login?next=${encodeURIComponent(next)}`} className="font-medium text-amber-400">
              Einloggen
            </Link>
          </p>
        </div>
